...
public class T008OnClick {
    ...
    @Test
    public void checkToastIsShownOnClick() throws ClassNotFoundException {
        Class handler = Class.forName("com.afundacion.fp.library.ClickHandler");
        Matcher<View> button = withText("Ver tostada");
        Matcher<View> toast = withText("¡Ha salido un poco churruscada!");
