...
public class T015BottomNavViewRespondsToClicks {
    ...
    public void checkToast1IsShown() {
        ...
        Espresso.onView(withText("Este es el primero")).inRoot(isOverlayWindow()).check(matches(isDisplayed()));
    }
    ...
    public void checkToast3IsShown() {
        ...
        Espresso.onView(withText("Este es el tercer Digimon")).inRoot(isOverlayWindow()).check(matches(isDisplayed()));
    }
