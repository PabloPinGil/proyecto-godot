...
public class T013ImageView {
    ...
    public void checkInitialImageIsPresent() throws InterruptedException {
        Matcher<View> contentDescription = withContentDescription("Un Digimon muy poderoso");
        Espresso.onView(contentDescription).check(matches(withDrawable(R.drawable.kabuterimon)));
    }
