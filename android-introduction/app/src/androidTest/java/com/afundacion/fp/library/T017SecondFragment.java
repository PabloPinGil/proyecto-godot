...
public class T017SecondFragment {
    ...
    public void checkCorrectImageShownAfterClick() {
        ...
        Matcher<View> contentDescription = withContentDescription("Otro Digimon muy poderoso");
        Espresso.onView(contentDescription).check(matches(withDrawable(R.drawable.garurumon)));
    }
    ...
    public void checkCorrectImageShownAfterClickAndNotOther() {
        Matcher<View> contentDescription1 = withContentDescription("Un Digimon muy poderoso");
        Matcher<View> contentDescription2 = withContentDescription("Otro Digimon muy poderoso");
        Espresso.onView(contentDescription1).check(matches(isDisplayed()));
        Espresso.onView(withBottomMenuItem("item2")).perform(click());
        Espresso.onView(contentDescription2).check(matches(withDrawable(R.drawable.garurumon)));
