...
public class T018ThirdFragment {
    ...
    public void checkCorrectImageShownAfterClick() {
        ...
        Matcher<View> contentDescription = withContentDescription("Un último Digimon fuerte");
    ...
    public void checkCorrectImageShownAfterClickAndNotOther() {
        ...
        Matcher<View> contentDescription2 = withContentDescription("Un último Digimon fuerte");
