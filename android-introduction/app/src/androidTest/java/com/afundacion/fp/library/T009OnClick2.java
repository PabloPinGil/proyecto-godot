...
public class T009OnClick2 {
    ...
    @Test
    public void checkToastIsShownOnClick() {
        Matcher<View> button = withText("Iniciar nueva actividad");
        Matcher<View> toast = withText("Arrancando otra actividad...");
