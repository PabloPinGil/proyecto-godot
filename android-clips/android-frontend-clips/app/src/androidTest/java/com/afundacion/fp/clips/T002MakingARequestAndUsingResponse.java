...
@LargeTest
public class T002MakingARequestAndUsingResponse extends TestRun {
    ...
    @Test
    public void checkRequestSentAndInitialToastShown() {
        assertTrue(getSessionClientRequests().contains("GET", "/health"));
        Matcher<View> toast = withText("Response OK: Server is healthy!");
