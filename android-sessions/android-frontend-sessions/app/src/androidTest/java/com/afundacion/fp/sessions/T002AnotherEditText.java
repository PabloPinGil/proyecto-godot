...
public class T002AnotherEditText {
    ...
    public void checkEditTextPasswordIsCorrect() {
        ...
        Espresso.onView(editTextWithHint("Contraseña")).check(isLeftAlignedWith(editTextWithHint("carole.doe")));
        Espresso.onView(editTextWithHint("Contraseña")).check(isRightAlignedWith(editTextWithHint("carole.doe")));
        Espresso.onView(editTextWithHint("Contraseña")).check(isTopToBottomOf(editTextWithHint("carole.doe")));
        ...
        Espresso.onView(editTextWithHint("carole.doe")).check(hasDeclaredId());
    }
