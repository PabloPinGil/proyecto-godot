...
public class T012ButtonThatFloats {
    ...
    public void checkButtonIsPresentAndShowsEmptyDialog() throws ClassNotFoundException, NoSuchFieldException {
        cls.getDeclaredField("buttonNewStatus");
        Espresso.onView(buttonWithText("Actualizar estado")).check(doesNotExist());
        ...
        Espresso.onView(buttonWithText("Actualizar estado")).check(matches(isDisplayed()));
    }
